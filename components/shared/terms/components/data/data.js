...
const agreementToTerms = [
  {
    content: (
      <>
        ...
        you, whether personally or on behalf of an entity (“you”) and Meet at
        the Bridge, INC ("Company," “we," “us," or “our”), concerning your
        ...
        <Link
          ...
          href="https://connectatthebridge.com/"
        >
          https://connectatthebridge.com/
        </Link>{' '}
        ...
        (collectively, the “Site”). We are registered in Delaware, United States
        and have our registered office at 1209 N Orange St, Wilmington, DE
        19801. You agree that by accessing the Site, you have read, understood,
...
const prohibitiveActivitiesList = [
  {
    item: (
      <>
  ...
  {
    item: <>Engage in unauthorized framing of or linking to the Site.</>,
  },
  {
    item: (
      <>
  ...
  {
    item: <>Use the Site to advertise or offer to sell goods and services.</>,
  },
];

const prohibitiveActivities = [
  {
    content: (
      <>
  ...
  },
  {
    content: (
      <ul>
        {prohibitiveActivitiesList.map((item, i) => (
...
const userGeneratedContributionsList = [
  {
    item: (
      <>
  ...
  {
    item: <>Your Contributions are not false, inaccurate, or misleading.</>,
  },
  {
    item: (
      <>
...
const userGeneratedContributions = [
  ...
  },
  {
    content: (
      <ul>
        {userGeneratedContributionsList.map((item, i) => (
          <li key={i}>{item.item}</li>
        ))}
      </ul>
    ),
...
const governingLaw = [
  {
    content: (
      <>
        ...
        agreements made and to be entirely performed within the State of Ohio,
...
const bindingArbitration = [
  {
    content: (
      <>
        ...
        arbitration will take place in Franklin, Ohio. Except as otherwise
  ...
  },
  {
    content: (
      <>
        ...
        courts located in Franklin, Ohio, and the Parties hereby consent to, and
...
const limitationsOfLiability = [
  {
    content: (
      <>
        ...
        CAUSE OF ACTION ARISING OR $2,500.00 USD. CERTAIN US STATE LAWS AND
    ...
    content: (
      <>
        <Typography sx={{ fontWeight: 700 }}>
          Meet at the Bridge, INC
        </Typography>
        <Typography sx={{ fontWeight: 700 }}>985 North High Street</Typography>
        <Typography sx={{ fontWeight: 700 }}>Apartment 315</Typography>
        <Typography sx={{ fontWeight: 700 }}>Columbus, OH</Typography>
        <Typography sx={{ fontWeight: 700 }}>United States</Typography>
        <Typography sx={{ fontWeight: 700 }}>Phone: 614-937-8563</Typography>
        <Typography sx={{ fontWeight: 700 }}>
          nolan@connectatthebridge.com
        </Typography>
      </>
    ),
  },
...
const terms = [
  {
    ...
    content: agreementToTerms.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: intellectualPropertyRights.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>User Represtentations</>,
    content: userRepresentations.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: userRegistration.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: prohibitiveActivities.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: userGeneratedContributions.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: contributionLicense.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>Submissions</>,
    content: submissions.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: thirdPartyWebsiteAndContent.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: siteManagement.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: privacyPolicy.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: copyrightInfringements.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: termAndTermination.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>Modifications And Inturruptions</>,
    content: modificationsAndInterruptions.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>Governing Law</>,
    content: governingLaw.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: disputeResolution.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>Corrections</>,
    content: corrections.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: limitationsOfLiability.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: indemnification.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  },
  {
    ...
    content: electronicCommunicationsTransactionsAndSignatures.map(
      (item, i) => (
        <Box key={i}>
          {item.content}
          <br />
  ...
  },
  {
    ...
    content: californiaResidents.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
  ...
  {
    title: <>Miscellaneous</>,
    content: miscellaneous.map((item, i) => (
      <Box key={i}>
        {item.content}
        <br />
        <br />
