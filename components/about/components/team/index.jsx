...
const teamMembers = [
  {
    ...
    writeUp: (
      ...
      >
        A native of Huber Heights, Ohio, Nolan Vannucci moved to Columbus after
        ...
        <br />
        <br />
        In September 2021, Nolan quit his day job in Finance Operations at J.P.
        Morgan Chase to finally embrace his entrepreneurial leanings full-time.
        The Bridge is the result.
        <br />
        <br />
  ...
  },
  {
    ...
    writeUp: (
      ...
      >
        Zach Livingston is a 2011 Ohio State graduate and an Army Veteran. After
        college, Zach worked in a number of different finance roles in both
        ...
        order)—playing guitar, eating cheesecake, and watching Buckeye football.
      </Typography>
    ),
  },
];
